...
<template>
  <div class="h-full flex flex-col">
    ...
    <div class="flex-1 grid grid-cols-3 gap-2 p-2 bg-gray-900" style="grid-template-rows: repeat(auto-fill, 32.5vh)">
      <div 
        v-for="(stream, i) in streamStore.streams" 
        :key="stream.id" 
        :class="['bg-gray-700 flex items-center justify-center', { 'col-span-2 row-span-2': (i % 6) == 0 }]"
      >
        <VideoStream
          class="w-full h-full"
